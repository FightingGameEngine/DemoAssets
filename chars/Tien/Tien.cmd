...
[Command]
name = "Atake de Palmas1"
command = ~D, DB, B , x
time = 15

[Command]
name = "Atake de Palmas2"
command = ~D, DB, B , y
time = 15
...
type = ChangeState
value = 1600
triggerall = command = "Atake de Palmas1"
trigger1 = statetype = S
trigger1 = ctrl = 1
...
type = ChangeState
value = 1610
triggerall = command = "Atake de Palmas2"
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2 = stateno = 200 && movecontact = 1
trigger3 = stateno = 201 && movecontact = 1
...
type = ChangeState
value = 1601
triggerall = command = "Atake de Palmas1" || command = "Atake de Palmas2"
triggerall = (stateno = 1600 && time >= 9) || (stateno = 1610 && time >= 14)
trigger1 = statetype = S
