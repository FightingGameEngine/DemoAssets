...
trigger5 = PrevStateNo = 1220
trigger6 = PrevStateNo = 1210
value = 100
...
triggerall = !(Enemy,HitDefAttr = SAC, AT,AA,AP)
...
triggerall = StateType = A
triggerall = P2Life > 0
trigger1 = movecontact && (stateno = 630)
value = 620
...
triggerall = Ctrl
triggerall = random <= 333
triggerall = prevstateno !=[4300,4399]
...
trigger2 = (numproj > 0) || (numhelper > 0)
value = 1650
...
trigger3 = p2stateno = 250 && MoveContact
value = 1700
...
triggerall = p2movetype != A
triggerall = P2Life > 0
triggerall = stateno = 1700 && MoveContact && P2BodyDist X <-45
trigger1 = time >=7
value = 1702
...
triggerall = p2movetype != A
triggerall = P2Life > 0
triggerall = stateno = 1702  && MoveContact && P2BodyDist X <-45
trigger1 = time >=7
value = 1703
...
type = ChangeState
value = 2100
triggerall = command = "refletir magias"
triggerall = power >= 200
...
value = 460
triggerall = var(22) = 0
triggerall = (command = "b") && (command = "holddiagfwd")
